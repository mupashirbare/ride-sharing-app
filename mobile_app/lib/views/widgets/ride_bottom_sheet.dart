      ...
      children: [
        Row(
          children: [
            ...
            const Expanded(
              child: Text('Current Location', style: TextStyle(fontSize: 16)),
            ),
          ],
        ),
        Container(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Text('\$10-12', style: TextStyle(color: Colors.grey[600])),
              ],
            ),
          ),
        ),
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 4),
                Text('\$15-18', style: TextStyle(color: Colors.grey[600])),
              ],
            ),
          ),
        ),
        ...
        children: [
          Row(
            ...
            children: const [
              ...
              Text('15 min', style: TextStyle(fontWeight: FontWeight.bold)),
            ],
          ),
          const SizedBox(height: 8),
          Row(
